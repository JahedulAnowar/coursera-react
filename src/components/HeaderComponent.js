...
class Header extends Component {
    ...
    toggleNav() {
        this.setState({
            isNavOpen: !this.state.isNavOpen, // value will be negated
        });
    }

    toggleModal() {
        this.setState({
            isModalOpen: !this.state.isModalOpen, // value will be negated
        });
    }
                    ...
                    <div className="container">
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                ...
                                <p>
                                    We take inspiratiopn from the World's best cuisines, and create
